...
(
 ...
 //This code came from PhotoshopMathFP - http://mouaif.wordpress.com/2009/01/05/photoshop-math-with-glsl-shaders/
 ...
 vec3 BlendHue(vec3 base, vec3 blend)
{
 ...
 void main()
 {
     ...
     vec3 blendedColor = BlendHue(textureColor2.rgb, textureColor.rgb);
